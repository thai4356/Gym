...
<head>
    ...
    <link rel="stylesheet" href="Public/assetsHomepage/css/vCP.css">
</head>
<body>
<br>
    ...
    <div class="col-75">
            ...
            <div style="width: 45%; float:left;margin-left: 2%">
                ...
                if($count==0)
                {
                    ...
                    <h3><a href="indexUser.php">Go to buy page</a></h3>
                    <?php
                                ...
                                <form name="f1" id="f1" action="?module=cart&act=update" method="post">
                                    ...
                                    foreach($rows as $row)
                                    {
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="number" name="qty[<?=$masp?>]" value="<?=$soluong?>" style="width: 100px;height: 100px"></td>
            ...
            <span class="iphone" style="width: 50%; float:right"">
                <form name="f2" id="f1" action="?module=checkout" method="post" onSubmit="return kt();">
                    ...
                    <p><span>Phone No</span>
                        <input type="text" name="dienthoai" id="dienthoai" required></p>
                    <fieldset>
